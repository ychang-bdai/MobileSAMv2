...
def parse_args():
    ...
    parser.add_argument("--ObjectAwareModel_path", type=str, default='./weights/ObjectAwareModel.pt', help="ObjectAwareModel path")
    parser.add_argument("--Prompt_guided_Mask_Decoder_path", type=str, default='./weights/Prompt_guided_Mask_Decoder.pt', help="Prompt_guided_Mask_Decoder path")
...
def create_model():
    Prompt_guided_path='./weights/Prompt_guided_Mask_Decoder.pt'
    obj_model_path='./weights/ObjectAwareModel.pt'
...
encoder_path={'efficientvit_l2':'./weights/l2.pt',
            'tiny_vit':'./weights/mobile_sam.pt',
            'sam_vit_h':'./weights/sam_vit_h.pt',}
